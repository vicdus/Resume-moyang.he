...
\geometry{left=1.7cm, top=0.8cm, right=1.7cm, bottom=0.7cm, footskip=0.0cm} % Configure page margins with geometry
...
\extrainfo{Permanent resident living in Seattle}


\position{Software Engineer{\enskip\cdotp\enskip}Backend{\enskip\cdotp\enskip}Full Stack} % Your expertise/fields


%\makecvfooter{}{Moyang HE~~~·~~~Résumé}{} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
